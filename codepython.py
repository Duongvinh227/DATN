...
tieu_de = Label(fram1,text = "ĐỒ ÁN TỐT NGHIỆP \n Đề Tài : Thiết kế chế tạo mô hình hệ thống phân loại \n rác thải tự động ứng dụng trí tuệ nhân tạo ",font = ("Helvetica",28),fg = "black",padx = 20,pady =10,relief  = "sunken",bd = 5,bg = "yellow")
...
#hien thi so luong
tieu_de_sl = Label(fram4,text = "Số lượng sản phẩm đã phân loại : ",fg="blue", font=("Helvetica", 15),bg ="cyan")
